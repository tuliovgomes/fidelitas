local mType = Game.createMonsterType("Nefarian")
local monster = {}

monster.name = "Nefarian"
monster.description = "Nefarian"
...
monster.attacks = {
	{name ="melee", interval = 1000, chance = 100, skill = 108, attack = 120},
	...
	{name ="combat", interval = 5000, chance = 100, type = COMBAT_DEATHDAMAGE, minDamage = -1500, maxDamage = -1600, range = 10, radius = 7, target = false, effect = CONST_ME_MORTAREA},
	...
	{name ="combat", interval = 1000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -935, maxDamage = -2055, range = 7, radius = 6, target = false, effect = CONST_ME_LOSEENERGY}
}
