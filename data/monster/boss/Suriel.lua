local mType = Game.createMonsterType("Suriel")
local monster = {}

monster.name = "Suriel"
monster.description = "anjo Suriel"
...
monster.attacks = {
	...
	{name ="combat", interval = 2500, chance = 80, type = COMBAT_PHYSICALDAMAGE, minDamage = -2200, maxDamage = -4200, range = 8, radius = 2, target = true, shootEffect = CONST_ANI_SPEAR},
	{name ="melee", interval = 4000, chance = 100, minDamage = -1280, maxDamage = -5955}
}

monster.defenses = {
	defense = 70,
	armor = 70,
	{name ="combat", interval = 9000, chance = 70, type = COMBAT_HEALING, minDamage = 30002, maxDamage = 40008, effect = CONST_ME_MAGIC_BLUE}
}
