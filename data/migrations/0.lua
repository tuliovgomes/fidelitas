function onUpdateDatabase()
	...
	-- Miner Sample
	db.query("UPDATE `players` SET `level` = 8, `vocation` = 5, `health` = 185, `healthmax` = 185, `experience` = 4200, `soul` = 100, `lookbody` = 113, `lookfeet` = 115, `lookhead` = 95, `looklegs` = 39, `looktype` = 129, `mana` = 90, `manamax` = 90, `town_id` = 8, `cap` = 470 WHERE `id` = 6;")
	return true
end
