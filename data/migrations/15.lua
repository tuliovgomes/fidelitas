function onUpdateDatabase()
	Spdlog.info("Updating database to version 16 (Rook sample and GOD player values)")
    -- Rook Sample
    ...
    -- GOD
	db.query("UPDATE `players` SET `health` = 155, `healthmax` = 155, `experience` = 100, `looktype` = 75, `town_id` = 8 WHERE `id` = 7;")
	return true
end
