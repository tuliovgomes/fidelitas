...
enum Vocation_t : uint16_t {
	...
	VOCATION_MASTER_SORCERER = 6,
	VOCATION_ELDER_DRUID = 7,
	VOCATION_ROYAL_PALADIN = 8,
	VOCATION_ELITE_KNIGHT = 9,
	VOCATION_BLACKSMITH = 10,

	VOCATION_ARCHMAGE = 11,
	VOCATION_CELTIC_DRUID = 12,
	VOCATION_MEDIEVAL_CROSSBOWMAN = 13,
	VOCATION_TEMPLAR_KNIGHT = 14,
	VOCATION_WEAPONSMITH = 15,

	VOCATION_ARCANE_WIZARD = 16,
	VOCATION_SPIRIT_HEALER = 17,
	VOCATION_SPARTAN_SPEARMAN = 18,
	VOCATION_CHAOS_KNIGHT = 19,
	VOCATION_ARTISAN_WEAPONSMITH = 20,

	VOCATION_DIVINE_WIZARD = 21,
	VOCATION_DIVINE_SHOOTER = 22,
	VOCATION_DIVINE_WARRIOR = 23,
	VOCATION_LAST = VOCATION_DIVINE_WARRIOR
};
